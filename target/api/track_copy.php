<?php
/**
 * Ruffian Target Promotion — Promocode Copy Tracking API Endpoint
 * Receives copy actions and logs them to copies.csv.
 *
...
$csvFile = dirname(__DIR__) . '/data/v2_copies.csv';
